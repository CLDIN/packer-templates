...
apt-get -o Dpkg::Options::="--force-confold" --allow-downgrades --allow-remove-essential --allow-change-held-packages -y dist-upgrade

echo "Enabling services"
systemctl enable cloud-init-main.service fstrim.timer qemu-guest-agent.service watchdog.service
